...
/**
 * ZaabuTV Design Tokens — Spacing & Dimensions
 *
 * Consistent spacing scale and component dimension tokens
 * used across all screens for visual rhythm.
 */
object Dimens {
    ...
    val MovieCardWidth = 140.dp
    val MovieCardHeight = 200.dp
    val MovieCardPosterRatio = 2f / 3f

    // ─── Featured Carousel ───────────────────────────────────────────
    val FeaturedCarouselHeight = 420.dp
    val FeaturedGradientHeight = 200.dp

    // ─── VJ Card Dimensions ─────────────────────────────────────────
    val VjAvatarSize = 64.dp
    val VjAvatarSizeLarge = 100.dp
